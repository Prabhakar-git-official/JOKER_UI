    ...
    return ( 
        <Layout>
            ...
            <Container>
                ...
                <div className='accordion-item accordion-item-pool mb-24'>
                    <div className='accordion-button flex-column'>
                        <div className='d-flex flex-wrap align-items-center w-100'>
                            <div className='acc-title-lg acc-title me-2 d-flex align-items-center'>
                                <img src={elemlogo} alt='image' />
                                <span class="ms-3 h5 mb-0">ELEM </span>
                                {/* <span class="ms-3 h5 mb-0">PTP &nbsp;$0.135</span> */}
                                <p className=' ms-1 mb-0'>&nbsp;${usdcprice ? parseFloat(usdcprice/100000000000).toFixed(1):'0.0'}</p> 
                                {/* <OverlayTrigger
                                    key="right"
                                    placement="right"
                                    overlay={
                                        <Tooltip id={`tooltip-right`}>
                                            Percentage changed in 24hours.
                                        </Tooltip>
                                    }
                                    >
                            ...
                            <div className='acc-content flex-grow-1 flex-wrap d-flex justify-content-around align-items-center'>
                                <div className='px-2 d-flex align-items-center'>
                                    <span className='text-muted me-2'>Total deposited </span>
                                    <h6>{ totalPTP ? parseFloat(Math.abs(100000 - (totalPTP/1000000))).toFixed(4) :'0.0'} ELEM</h6>
                                </div>
                                <div className='px-2 d-flex align-items-center'>
                                    <span className='text-muted me-2'>Pending Rewards</span>
                                        <OverlayTrigger
                                        key="left"
                                        placement="left"
                                        overlay={
                                            <Tooltip id={`tooltip-left`}>
                                                ${parseFloat(Math.abs(Circulatingsupply*usdcprice/100000000000000000000000)).toFixed(2)}
                                            </Tooltip>
                                        }
                                        >
                                            <h6> {parseFloat(Math.abs(Circulatingsupply/100000000)).toFixed(2)}
</h6>
                                        </OverlayTrigger>
                                </div>
                            </div>

                            <div className='acc-btn text-center mx-md-0 mx-auto pt-md-0 pt-2'>
                                {/* <Button variant='blue' onClick={handleTrade}>Trade</Button> */}
                                <span class="ms-3 h5 mb-0">APR </span>
                                <p className=' ms-1 mb-0'>$1200
                                {/* {BoostingApr ? parseFloat(Math.abs(BoostingApr/100)).toFixed(4):'0.0'} */}
                                %</p> 

                            </div>
                        </div>

                        <div className='accordion-divider mt-3 w-100 d-flex align-items-center justify-content-center'>
                            <div className='d-flex px-3 align-items-center justify-content-center'>
                                <img src={algologo} alt='image' />
                                <img src={elemlogo} alt='image' />
                                <span className='ms-2 me-3'>ALGO-ELEM</span>
                                <Button variant='blue' onClick={handleToggle} className='p-2'>
                                    {show ? (
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className='m-0' viewBox="0 0 16 16">
                    ...
                    {show && (
                        <div className='accordion-body pt-0 border-0'>
                            <Row className='justify-content-center col-info'>
                                <Col sm={6} lg={4} className="mb-sm-0 mb-4">
                                <div className='acc-btn text-center mx-md-0 mx-auto pt-md-0 pt-2'>
                                <Button variant='blue' >
                                <a className=' d-flex align-items-center ' href={"https://testnet.tinyman.org/#/swap?asset_in=0&asset_out=117481657"} target="_blank" rel="noreferer">
                            <svg class=" me-2" fill="currentColor" width="16" height="16" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M15.8333 15.8333H4.16667V4.16667H10V2.5H4.16667C3.24167 2.5 2.5 3.25 2.5 4.16667V15.8333C2.5 16.75 3.24167 17.5 4.16667 17.5H15.8333C16.75 17.5 17.5 16.75 17.5 15.8333V10H15.8333V15.8333ZM11.6667 2.5V4.16667H14.6583L6.46667 12.3583L7.64167 13.5333L15.8333 5.34167V8.33333H17.5V2.5H11.6667Z"></path></svg>
                            Trade on Tinyman
                        </a>
                                </Button>
                            </div><br/>
                                    ...
                                    <div className='d-flex align-items-center justify-content-center'>
                                        ...
                                        disabled={!veptpptpoptin} 
                                        onClick={()=>assetoptin()} >Asset Opt-In</ButtonLoad>
                                        {/* </>):(<> */}
                                        &nbsp;
                                            <Button variant="blue" 
                                        disabled={veptpptpoptin} 
                                        onClick={()=>clickevent("Deposit")} >Deposit</Button>
                                        {/* </>)} */}
                                       
                                        {/* <div className='ps-3'>
                                            <p className='mb-0'>
                                                <span className='text-muted text-end'>Liquidity</span> 
                                                <OverlayTrigger
                                                    key="left"
                                                    placement="left"
                                                    overlay={
                                            ...
                                            <p className='mb-0'>
                                                <span className='text-muted text-end'>APR</span> 
                                                39.6%
                                                <OverlayTrigger
                                                    key="left"
                                                    placement="left"
                                                    overlay={
                                                        <Tooltip id={`tooltip-left`}>
                                                            Total APR from pool fee and token emission.
                                                        </Tooltip>
                                                    }
                                                    >
                                                        <svg className="ms-2" xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16">
                                ...
                                <a className=' d-flex align-items-center'  target="_blank" rel="noreferer">
                            <svg class="me-2" fill="currentColor"  width="16" height="16" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M15.8333 15.8333H4.16667V4.16667H10V2.5H4.16667C3.24167 2.5 2.5 3.25 2.5 4.16667V15.8333C2.5 16.75 3.24167 17.5 4.16667 17.5H15.8333C16.75 17.5 17.5 16.75 17.5 15.8333V10H15.8333V15.8333ZM11.6667 2.5V4.16667H14.6583L6.46667 12.3583L7.64167 13.5333L15.8333 5.34167V8.33333H17.5V2.5H11.6667Z"></path></svg>
                            Trade on Algofi
                        </a>
                                </Button>
                                    ...
                                    <div className='d-flex align-items-center justify-content-center'>
                                       {stakedAmount > 1?
                                       (<><Button variant="blue" disabled={veptpptpoptin}  onClick={()=>clickevent("Withdraw")} >Withdraw</Button></>):
                                       (<><Button variant="blue" disabled={true}  onClick={()=>clickevent("Withdraw")} >Withdraw</Button></>)} 
                                        {/* <div className='ps-3'>
                                            <p className='mb-0'>
                                                <span className='text-muted text-end'>Liquidity</span> 
                                                <OverlayTrigger
                            ...
                            {/* <Row className='justify-content-center col-info'>
                                <Col sm={6} lg={4} className="mb-sm-0 mb-4">
                                    <div className='d-flex align-items-center mb-1 justify-content-center'>
                                        <img src={elemlogo} alt='image' /> <h6>TraderJoe</h6>
                                    </div>
                                    <div className='d-flex align-items-center justify-content-center'>
                                        <Link to="/" className='d-inline-flex align-items-center btn-outline-white'>
                                            <span>Farm</span> 
                ...
                <div className='accordion-item accordion-item-pool mb-24'>
                    ...
                    <div className='accordion-button flex-column'>
                        ...
                        <div className='d-flex flex-md-row flex-column align-items-center justify-content-around w-100'>
                            ...
                            <span className='text-muted me-2'>My total deposits</span>
                                ...
                                {/* <OverlayTrigger
                                    ...
                                    overlay={
                                        <Tooltip id={`tooltip-left`}>
                                         {stakedAmount ? parseFloat(stakedAmount/1000000).toFixed(3): '0.0'} 
                                        </Tooltip>
                                    }
                                    >
                                        <h4 className='mb-0 ms-2'><small>{stakedAmount ? parseFloat(stakedAmount/1000000).toFixed(3): '0.0'} ELEM</small></h4>
                                    </OverlayTrigger> */}
                                    {/* <br/> */}
                                    <h4 className='mb-0 ms-2'><small>{stakedAmount ? parseFloat(stakedAmount/1000000).toFixed(3): '0.0'}   <span className='text-muted me-2'>ELEM</span></small></h4>
                                    
                            </div>
                            <div className='d-flex align-items-center'>
                                <div className='me-3 '>
                                <span className='text-muted me-2'>Rewards Earned</span> 
                                    {/* <small> </small> */}
                                    {/* <OverlayTrigger
                                        key="left"
                                        placement="left"
                                        overlay={
                                            <Tooltip id={`tooltip-left`}>
                                           Amount can be claimed only greater than 0.001
                                            </Tooltip>
                                        }
                                        >
                                            <h4 className='mb-0 ms-2'>{claimamount?parseFloat(claimamount * (70/100)/1000000000000).toFixed(4):'0.0'}<small>vELEM</small><br/><small>ELEM</small></h4>
                                             <h4 className='mb-0 ms-2'>{claimamount?parseFloat(claimamount * (30/100)/1000000000000).toFixed(4):'0.0'}ELEM</h4> 
                                        </OverlayTrigger> */}
                                        <br/>
                                        <span className='text-muted me-2'>vELEM:</span>    {claimamount?parseFloat(claimamount * (70/100)/1000000000).toFixed(4):'0.0'}  
                                        <br/>
                                        <span className='text-muted me-2'>ELEM:</span> {claimamount?parseFloat(claimamount * (30/100)/1000000000).toFixed(4):'0.0'}
                                </div>
                                
                                {claimamount/1000000000 > 0.001 ?(<>
