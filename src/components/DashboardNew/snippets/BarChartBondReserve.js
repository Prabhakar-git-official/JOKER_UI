...
const BarChartPrice = () => {
    ...
    const marketcapHistory = async () =>
    {
        ...
        // let creditBalance = ethers.utils.formatUnits(await creditcontract.balanceOf(DAOReserveAddress),9);
        let dimeBalance = ethers.utils.formatUnits(await dimecontract.balanceOf(TreasuryAddress),9);
        let usdcBalance = ethers.utils.formatUnits(await USDCcontract.balanceOf(TreasuryAddress),9);
