...
import GNFTTradingCardTab from './GAucTradingCardTab';
import GNFTArtTab from './GAucArtTab';
import GNFTPetTab from './GAucPetTab';
import GNFTPhotographyTab from './GAucPhotographyTab';
import GNFTSportsTab from './GAucSportsTab';
import GNFTExploreTab from './GAucExploreTab';
const algosdk = require('algosdk'); 


const TopCollectionsAuction = () => {
    useEffect(() => {
    ...
    const[getImgreffalgosale,setgetImgreffalgosale]=useState([]);    
    console.log("CCcheck",getImgreffalgosale)
            ...
            if (data) {
              data.forEach((d) => {                
                ...
                Object.keys(value).map(async(k)=>{   
                    if(value[k].NFTModel === "Auction-NFT"){
                        req.push(            
                            {
...
export default TopCollectionsAuction;