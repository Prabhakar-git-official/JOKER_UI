...
const algodClientGet = new algosdk.Algodv2('', node['algodclient'], '');
    ...
    (
        <div>
            <p> Transaction is successful &nbsp;<a style={{color:'#919cff'}} href={txId} target="_blank" rel="noreferrer"><br/><p style={{fontWeight: 'bold'}}>View in Sepolia Explorer <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
